	...
	<div>
		<div id="top">
			...
			<ul>
				...
				<li class="right"><i class="fa fa-shopping-cart" style="font-size:36px"></i> <a href="cart.php">Cart</a></li>
				...
				<div class="footer_sub2">
					<center>
						...
						<ul>
                            ...
                            <li><a href="https://www.facebook.com/" class="fa fa-facebook"></a>facebook</li>
                            <li><a href="https://twitter.com/?lang=en" class="fa fa-twitter"></a>twitter</li>
                            <li><a href="https://plus.google.com/discover" class="fa fa-google"></a>google</li>
                            <li><a href="https://ke.linkedin.com/" class="fa fa-linkedin"></a>linkedin</li>
                            <li><a href="https://www.youtube.com/" class="fa fa-youtube"></a>youtube</li>
                            <li><a href="https://www.instagram.com/accounts/login/" class="fa fa-instagram"></a>instagram</li>
                            <li><a href="https://www.pinterest.com/" class="fa fa-pinterest"></a>pinterest</li>
						</ul>
					</center>
				</div>
